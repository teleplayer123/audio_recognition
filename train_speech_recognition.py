...
def visualize_specs(ds):
    label_names = np.array(ds.class_names)
    example_spectrograms, example_spect_labels = take_first(ds)
    rows = 3
    cols = 3
    n = rows*cols
...
example_spectrograms = take_first(train_spectrogram_ds)
...
res = model.evaluate(test_spectrogram_ds, return_dict=True)
print(res)
